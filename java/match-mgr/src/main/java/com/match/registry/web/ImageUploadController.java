...
public class ImageUploadController {
    ...
    @DeleteMapping("/{uploadId}") public ResponseResult<Object> deleteFailed(@PathVariable String uploadId) { roleGuard.requireSuperAdmin(); service.deleteFailed("SUPER_ADMIN", uploadId); return Response.makeOKRsp(null); }
