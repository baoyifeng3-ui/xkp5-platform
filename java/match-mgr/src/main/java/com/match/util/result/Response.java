...
public class Response {
    ...
    public static <T> ResponseResult<T> makeErrRsp(Exception e) {


        return new ResponseResult<T>().setCode(ResultCode.INTERNAL_SERVER_ERROR)
                .setMsg(e.toString() + "/n" + ExceptionUtil.getStackTrace(e));
    }
