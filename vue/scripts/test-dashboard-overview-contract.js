...
assert.match(page, /import\s*\{\s*getDashboardOverview\s*\}\s*from\s*["']@\/api\/DashboardOverview["']/)
...
assert.ok(page.includes('startClassTrainingCourse'))
assert.ok(page.includes('startClassTrainingIndependent'))
