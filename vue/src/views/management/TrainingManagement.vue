...
<script>
import { listAdminTrainingEnvironments, startAdminTrainingEnvironment, stopAdminTrainingEnvironment, restoreAdminTrainingEnvironment } from '@/api/TrainingEnvironments'
