...
XKP_HOST_IDENTITY_OUTPUT=/etc/xkp/host-identity.json "$install_dir/deploy/host-identity.sh"
"$install_dir/deploy/agent-ca.sh" --management-ip "$server_ip" --output "$agent_tls_dir"
